...
Analisis non probabilitysampling padaa survey online
# Analisis Non-probability sampling pada survey online 
...
## Variabel Penelitian
X1:  Media sosial membantu saya memperoleh informasi pembelajaran  
X2:  Penggunaan media sosial membuat waktu belajar saya berkurang  
X3:  Saya sering menunda tugas kuliah karena bermain media sosial 
X4:  Media sosial meningkatkan motivasi saya dalam belajar  
X5:  Saya mampu mengatur waktu antara penggunaan media sosial dan kegiatan akademik  
...
Berdasarkan hasil weighting, proporsi perempuan pada populasi sebesar 80,5%, sedangkan pada sampel sebesar 75,6%. Karena proporsi perempuan dalam sampel lebih kecil dibandingkan populasi, maka diperoleh weight sebesar 1,065 sehingga data responden perempuan perlu diperbesar agar lebih mewakili populasi sebenarnya.

Sementara itu, proporsi laki-laki pada populasi sebesar 19,5%, sedangkan pada sampel sebesar 24,4%. Karena proporsi laki-laki pada sampel lebih besar dibandingkan populasi, maka diperoleh weight sebesar 0,799 sehingga bobot responden laki-laki perlu dikurangi agar hasil estimasi lebih representatif terhadap populasi.
...
Keterangan:
Naive estimation dihitung tanpa pembobotan.
Weighted estimation dihitung dengan penyesuaian weight berdasarkan jenis kelamin:
Perempuan = 1,065
Laki-laki = 0,799
Berdasarkan hasil perbandingan, nilai weighted estimation tidak berbeda jauh dengan naive estimation. Hal ini menunjukkan bahwa distribusi sampel terhadap populasi sudah cukup representatif sehingga proses pembobotan tidak menyebabkan perubahan estimasi yang besar.

Pada variabel X1, nilai estimasi mengalami sedikit penurunan dari 0,822 menjadi 0,815 setelah dilakukan weighting. Namun, kategori tetap menunjukkan tingkat yang sangat tinggi sehingga media sosial masih dianggap membantu responden dalam memperoleh informasi pembelajaran.

Variabel X2 dan X3 juga mengalami sedikit penurunan setelah weighting. Hal ini menunjukkan bahwa setelah penyesuaian proporsi jenis kelamin, pengaruh media sosial terhadap pengurangan waktu belajar dan penundaan tugas menjadi sedikit lebih rendah.

Sementara itu, pada variabel X4 dan X5 terjadi sedikit peningkatan nilai weighted estimation dibanding naive estimation. Hal ini mengindikasikan bahwa setelah penyesuaian bobot, responden cenderung sedikit lebih setuju bahwa media sosial dapat meningkatkan motivasi belajar dan membantu pengaturan waktu akademik.

Pada variabel X6, nilai weighted estimation sedikit menurun dibanding naive estimation, sehingga pengaruh media sosial terhadap prestasi akademik tetap berada pada kategori rendah.

Secara keseluruhan, hasil naive estimation dan weighted estimation menunjukkan pola yang hampir sama. Dengan demikian, dapat disimpulkan bahwa media sosial lebih banyak dimanfaatkan sebagai sarana memperoleh informasi pembelajaran dibandingkan memengaruhi prestasi akademik mahasiswa.
